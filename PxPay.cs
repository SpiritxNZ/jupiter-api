...
namespace PaymentExpress
{
    namespace PxPay
    {
        ...
        public class PxPay
        {
            ...
            //private string _WebServiceUrl = Configuration.GetSection("WindCave:PaymentExpress.PxPay").Value;
            //private string _WebServiceUrl = ConfigurationManager.GetSection("WindCave:PaymentExpress.PxPay").ToString();
            //private string _WebServiceUrl;
            private string _PxPayUserId;
            private string _PxPayKey;
            private string _WebServiceUrl;
            //private string _WebServiceUrl = windCaveSetting.Value;["PaymentExpress.PxPay"];
            ...
            public PxPay(string PxPayUserId, string PxPayKey)
            {
                ...
                _PxPayKey = PxPayKey;
                _WebServiceUrl = Custom.AppSetting["WindCave:PaymentExpress_PxPay"];
            }

            //public PxPay(IConfiguration configuration)
            //{
            //    _configuration = configuration;
            //    _WebServiceUrl = _configuration.GetSection("WindCave:PaymentExpress.PxPay").Value;
